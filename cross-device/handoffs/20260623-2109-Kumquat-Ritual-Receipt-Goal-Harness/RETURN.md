...
- [x] `git fetch && git checkout kumquat-2026-06-01-hygiene && git pull` → **HEAD `d510204`** (clean; `137f97e` ancestor ✓)
...
**Git receipt:** `d510204` on `kumquat-2026-06-01-hygiene`; `137f97e` is ancestor of HEAD (ANCESTOR_CHECK=PASS per `git.log`)
