...
- **Ball Holder Rule (Mandatory at End of Every Summary)**: Every summary must end with a clear-cut statement of who has the ball: **Washington has the ball.** or **Oregon has the ball.** (short reason optional in parens). This is the new permanent convention (see coordination/README.md for full rule + migration from old Linux Turn Status format). Both humans and agents must know instantly whose move it is.
