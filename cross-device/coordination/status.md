...
**Last Updated:** 2026-05-27 (by Windows Grok during Kumquat) - Bing Bang Boom summary rule injected into core protocol (coordination/README, SKILL primes, HANDOFF_FORMAT template/guidelines, windows-instructions, linux-instructions with dedicated Prime Directives section for Linux). Every summary paragraph on both sides (especially Linux) now required to contain bing, bang or boom. Rule adoption complete + signed. Prior 0200 + wave closures stand.
