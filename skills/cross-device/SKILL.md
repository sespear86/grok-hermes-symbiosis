...
- ~~Kanban-style live dashboard on top of the handoffs/ folder.~~ **Shipped (AUTON 3694a72b):** `symbiosis-handoff-dashboard` + `start-handoff-dashboard` launchers — PLAYBOOK §2.3c, MIRROR §14. CLI board: **6239aa70** `symbiosis-kanban`.
...
<!-- Edited: 2026-06-04 | Device: Washington Linux | By: Grok (AUTON 3694a72b) --> Live dashboard Forward Vision struck. OPEN_ITEMS #4 live surface satisfied with 3694a72b + 6239aa70 CLI. -->
